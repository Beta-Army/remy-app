...
import com.example.remy.morningactions.MorningActions
...
class VerifyActionFragment : Fragment(), FrameProcessor {
    ...
    fun drawOverlines(face: FirebaseVisionFace) {
        ...
        if (verifier is EyeballVerifier || verifier is WinkVerifier) {
            ...
            val upperLipTopContours = face.getContour(UPPER_LIP_TOP).points
            ...
            val upperLipBottomContours = face.getContour(UPPER_LIP_BOTTOM).points
            ...
            val lowerLipTopContours = face.getContour(LOWER_LIP_TOP).points
            ...
            val lowerLipBottomContours = face.getContour(LOWER_LIP_BOTTOM).points
